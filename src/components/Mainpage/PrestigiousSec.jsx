  ...
  const itemsEn = [
    {
      id: 1,
      comment:
        "The short game played on detailed text is more effective than getting involved in lengthy games. This test is also highly beneficial for both employers and job seekers, saving time and yielding high results.",
      name: "E. Otgontuya",
      position: "Human Resource Development Manager at TESCO LLC",
      img: "./test.png",
    },
    {
      id: 2,
      comment:
        "In the field of human resources, innovative methods are being introduced. With increasing number of diverse stakeholders and abundant data, it is believed that the ability to work is likely to make a significant contribution to the overall history of capacity development.",
      name: "D. Erdenebayar",
      position: "Training and Development Manager at Coca-Cola",
      img: "./test.png",
    },
    {
      id: 3,
      comment:
        "The key to successful decision making lies in having accurate data. Using Metacog allows employees to successfully achieve the desired level of competence in human resource management by engaging in the latest and innovative methods.",
      name: "D. Altantuya",
      position: "Human Resource Director at Mandal Finance",
      img: "./test.png",
    },
  ];
