      ...
      <div className="flex justify-center ">
        <div>
          <p className="text-style sm:text-[48px]  text-[36px] text-center font-bold">
            Client’s <span className="text-[#fff]">Testimonials</span>
          </p>
          ...
          {items.map((item) => {
            return (
              <SwiperSlide key={item.id}>
                <div className="bg-white  rounded-xl me-5 pointer-events-none">
                  <div className="p-5  ">
                    <svg
                    ...
                    <p className="text-[16px] sm:text-[21px] sm:w-[348px] w-[271px] my-4">
                      {item.comment}
                    </p>
                  </div>
                  <hr />
