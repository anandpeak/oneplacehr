      ...
      <div className=" w-10/12  m-auto my-20 ">
        ...
        <div className="mt-10 flex items-start justify-between">
          <div>
            ...
            <div className="flex">
              <p className="text-[30px] font-bold text-style">32%</p>
              <p
                className={`${
                  !isChecked ? "hidden" : "block"
                }  ms-2 text-[30px] font-bold text-[#4FBF4F]`}
                style={{
            ...
            <div className="flex w-[160px] me-2">
              <p className="text-[30px] font-bold text-style">44%</p>
              <p
                style={{
                  transition: "opacity 0.5s ease-in-out",
                  opacity: isChecked ? "1" : "0",
          ...
          <div>
            ...
            <div className="flex w-[160px] ">
              <p className="text-[30px] font-bold me-5 text-style">44%</p>
              <p
                style={{
                  transition: "opacity 0.5s ease-in-out",
                  opacity: isChecked ? "1" : "0",
